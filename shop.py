shop=[{"id":1001,"Name":"cake","Available":10,"Price":250,"Original_Price":200},
       {"id":1002,"Name":"apple","Available":12,"Price":500,"Original_Price":450},
       {"id":1003,"Name":"orange","Available":100,"Price":750,"Original_Price":700},
       {"id":1004,"Name":"chips","Available":20,"Price":350,"Original_Price":300},
       {"id":1005,"Name":"ice cream","Available":15,"Price":400,"Original_Price":300}]
shop1=shop
temp=[]
order=""
...
def placeOrder():
    ...
    for d in shop:
        if d["id"]==p_id:
            ...
            conform=input("\nDo you want to place an order on the shown product : Y/N ")
